...
rm -rf $HOME/usr/local/* # clean up previous downloads
...
# setup our targets
rustup target install aarch64-linux-android armv7-linux-androideabi x86_64-linux-android i686-linux-android
mkdir -p target/{aarch64-linux-android,x86_64-linux-android,armv7-linux-androideabi,i686-linux-android}/release/deps
...
cargo ndk --target=armeabi-v7a build --lib --release
