...
use crate::rotation::RotationParty1Message1;
use crate::rotation::party2::Rotation2;
...
pub fn rotate_master_key(wallet: wallet::Wallet, client_shim: &ClientShim) -> wallet::Wallet {
    ...
    let coin_flip_party1_first_message: coin_flip_optimal_rounds::Party1FirstMessage<Secp256k1, Sha256> =
